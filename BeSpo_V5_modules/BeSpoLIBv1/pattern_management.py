...
from global_config import NUM_PATTERNS, SEQUENCE_LENGTH, NUM_VOICES, sequences, current_voices, current_patterns
...
def load_pattern(pattern_index):
    ...
    print(f"Loading pattern {pattern_index}: voices = {current_voices}, patterns = {current_patterns}")
