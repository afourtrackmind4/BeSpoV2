...
# This should initialize the sequences for multiple patterns
...
current_pattern = 0  # Initialize current pattern to the first one
...
try:
    ...
    # Ensure the sequence variable is initialized
